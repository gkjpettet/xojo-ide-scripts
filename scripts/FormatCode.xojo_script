...
//   * Dr Garry Pettet <contact@garrypettet.com>
// 

Const kVersion = "2023r2"
...
"If", "Then", "In", "Is", "IsA", "Lib", "Loop", "Me", "New", "Nil", "Optional", "Or", "ParamArray", _
...
"GOTO", "If", "Then", "In", "Is", "IsA", "Lib", "Loop", "New", "Nil", "Optional", "Or", "ParamArray", _
...
"BackgroundTasks", "BoundsChecking", "BreakOnExceptions", "DisableAutoWaitCursor", _
"DisableBackgroundTasks", "DisableBoundsChecking", "Error", "NilObjectChecking", _
"StackOverflowChecking", "Unused", "Warning", "X86CallingConvention", "Var")
